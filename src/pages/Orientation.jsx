...
const MAJOR_SUBJECT_RELATIONS = {
  ...
  "طب الأسنان": ["العلوم الطبيعية", "الفيزياء"],
  "الصيدلة": ["العلوم الطبيعية", "الفيزياء", "الرياضيات"],
  "شبه طبي": ["العلوم الطبيعية"],
  "بيطرة": ["العلوم الطبيعية", "الفيزياء"],
  "هندسة مدنية": ["الرياضيات", "الفيزياء"],
  "هندسة معمارية وعمران": ["الرياضيات", "الفيزياء"],
  "هندسة ميكانيكية": ["الرياضيات", "الفيزياء"],
  "هندسة كهربائية": ["الرياضيات", "الفيزياء"],
  "هندسة كيميائية": ["الرياضيات", "الفيزياء"],
  "هندسة صناعية": ["الرياضيات", "الفيزياء"],
  "إعلام آلي": ["الرياضيات", "الفيزياء"],
  "الرياضيات والإعلام الآلي": ["الرياضيات", "الفيزياء"],
  "علوم وتكنولوجيا": ["الرياضيات", "الفيزياء"],
  "علوم المادة": ["الرياضيات", "الفيزياء"],
  "علوم الطبيعة والحياة": ["العلوم الطبيعية", "الفيزياء"],
  "اللغات الأجنبية": ["اللغة العربية", "اللغة الإنجليزية", "اللغة الفرنسية", "لغة أجنبية ثالثة"],
  "الحقوق": ["اللغة العربية", "التاريخ والجغرافيا", "الفلسفة"],
  "العلوم الاقتصادية، التجارية وعلوم التسيير": ["الرياضيات", "الاقتصاد والمناجمنت", "التسيير المحاسبي والمالي"],
  "العلوم السياسية": ["التاريخ والجغرافيا", "اللغة العربية", "الفلسفة"],
  "العلوم الإنسانية والاجتماعية": ["التاريخ والجغرافيا", "الفلسفة", "اللغة العربية"],
  "علوم وتقنيات النشاطات البدنية والرياضية": ["العلوم الطبيعية", "الفيزياء"],
  "فنون": ["اللغة العربية", "الفلسفة"],
  "أدب عربي": ["اللغة العربية وآدابها", "الفلسفة"],
  "إعلام واتصال": ["اللغة العربية", "التاريخ والجغرافيا", "الفلسفة"],
  "أمازيغية": ["اللغة العربية", "التاريخ والجغرافيا"],
  "تاريخ وجغرافيا": ["التاريخ والجغرافيا", "اللغة العربية", "الفلسفة"],
  "فلسفة": ["الفلسفة", "الرياضيات"],
  "لغة انجليزية": ["اللغة الإنجليزية", "اللغة العربية", "الفلسفة"],
  "لغة فرنسية": ["الاللغة الفرنسية", "اللغة العربية", "الفلسفة"],
  "هيدروكربورات وكيمياء": ["الرياضيات", "الفيزياء"],
  "رياضيات": ["الرياضيات", "الفيزياء"],
  "فيزياء": ["الفيزياء", "الرياضيات"],
  "كيمياء": ["الفيزياء", "العلوم الطبيعية"],
  "علوم بيولوجية": ["العلوم الطبيعية", "الفيزياء"],
  "علوم بيئية": ["العلوم الطبيعية", "الفيزياء"],
  "تكنولوجيا فلاحية وغذائية": ["العلوم الطبيعية", "الفيزياء"],
  "علوم اقتصادية": ["الرياضيات", "الاقتصاد والمناجمنت"],
  "علوم تجارية": ["الرياضيات", "الاقتصاد والمناجمنت"],
  "علوم التسيير": ["الرياضيات", "الاقتصاد والمناجمنت"],
  "مالية ومحاسبة": ["الرياضيات", "التسيير المحاسبي والمالي"],
  "علم النفس": ["الفلسفة", "اللغة العربية"],
  "علم الاجتماع": ["الفلسفة", "اللغة العربية"],
  "تاريخ": ["التاريخ والجغرافيا", "اللغة العربية"],
  "علم الآثار": ["التاريخ والجغرافيا", "اللغة العربية"],
  "علوم إعلام واتصال": ["اللغة العربية", "الفلسفة"],
  "علوم المكتبات": ["اللغة العربية", "الفلسفة"],
  "ترجمة": ["اللغة العربية", "اللغة الفرنسية", "اللغة الإنجليزية"],
  "علوم إسلامية": ["التربية الإسلامية", "اللغة العربية"],
  "تربية بدنية ورياضية": ["العلوم الطبيعية", "الفيزياء"],
  "تعليم": ["الفلسفة", "اللغة العربية"],
};
